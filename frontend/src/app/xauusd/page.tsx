...
import { Coins, TrendingDown, TrendingUp, ShieldAlert, Sparkles, CheckCircle2, AlertCircle } from "lucide-react";
...
export default function XAUUSDOutlookPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="p-5 md:p-6 space-y-6 max-w-[1600px] w-full mx-auto">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold font-mono text-slate-100 tracking-wider">
                  XAUUSD (GOLD) FUNDAMENTAL OUTLOOK
                </h1>
                <p className="text-xs text-slate-400 font-mono">
                  Gold Macro Intelligence • Real Yields • Central Bank Accumulation • Geopolitical Risk
                </p>
              </div>
            </div>
        ...
        {/* Primary Drivers & Market Reaction Validation */}
          ...
          <div className="bg-surface-200 border border-border rounded-xl p-5 shadow-card space-y-3">
            ...
            <div className="p-3 bg-surface-300/70 rounded border border-border space-y-2">
              <span className="text-[11px] font-mono text-slate-400 block uppercase">
                Observed Price Action vs Macro Expectation:
              </span>
        ...
        {/* Bullish vs Bearish Factors Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Bullish Factors */}
        ...
        {/* Key Upcoming Events Watchlist */}
        <div className="bg-surface-200 border border-border rounded-xl p-5 shadow-card space-y-3">
          <h2 className="text-sm font-bold font-mono text-slate-100 uppercase tracking-wider">
            What to Watch Next (Key Catalysts for XAUUSD)
          </h2>
